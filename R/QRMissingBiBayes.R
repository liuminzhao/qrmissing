...
########################################
    ...
    for (iscan in 1:nscan) {
        ...
        if (method == "whole") {
            ...
            logpriorc <- dgamma(sigma1c, sigmaa, sigmab, log = T)
            logprioro <- dgamma(sigma1, sigmaa, sigmab, log = T)
            ...
            logpriorc <- dgamma(sigma21c, sigmaa, sigmab, log = T)
            logprioro <- dgamma(sigma21, sigmaa, sigmab, log = T)
