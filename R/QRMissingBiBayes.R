...
########################################
  ...
  loglikeo <- LLBiSingle(gamma1, beta1, sigma1,
  ...
  for (iscan in 1:nscan) {
    ...
    for (i in 1:xdim){
      ...
      loglikec <- LLBiSingle(gamma1c, beta1, sigma1,
                      gamma2, beta2sp, sigma21, sigma21sp, betay, betaysp,
                      p, tau, y, X, R)
    ...
    for (i in 1:xdim){
      ...
      loglikec <- LLBiSingle(gamma1, beta1c, sigma1,
                      gamma2, beta2sp, sigma21, sigma21sp, betay, betaysp,
                      p, tau, y, X, R)
    ...
    loglikec <- LLBiSingle(gamma1, beta1, sigma1c,
                    gamma2, beta2sp, sigma21, sigma21sp, betay, betaysp,
                    p, tau, y, X, R)
    ...
    for (i in 1:xdim){
      ...
      loglikec <- LLBiSingle(gamma1, beta1, sigma1,
    ...
    ## cat(loglikec, loglikeo, logpriorc, logprioro, logcgk1c, logcgk1o,
    ##     logcgk21c, logcgk21o, '\n')
    ## cat(gamma1c, gamma1, beta1c, beta1, sigma1c, sigma1, gamma2c, gamma2,
    ##     sigma21c, sigma21, betayc, betay, pc, p, '\n')

    ## SP
    beta2sp <- rnorm(xdim, beta2pm, beta2pv)
    sigma21sp <- max(0.1, rnorm(1, sigma21sppm, sigma21sppv))
