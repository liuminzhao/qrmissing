...
##' @export
LLBiMixToursMNAR <- function(gamma1, beta1, gamma2, beta2sp, mu1, sigma1, mu2, sigma2, omega11, omega10, omega21, omega20sp, betay, betaysp, p, tau, y, X, R, K, G1, G2){
    ...
    dd <- matrix(0, n, 2)
    dd <- .Fortran("mydelta2bisemixmnar",
                   x = as.double(X),
...
##' @author Minzhao Liu, Mike Daniels
##' @export
ToursMNARBayesMix <- function(y, R, X, tau = 0.5,
...
########################################
    ...
    ## first
    loglikeo <- LLBiMixToursMNAR(gamma1, beta1, gamma2, beta2sp, mu, sigma, mu, sigma, omega, omega, omega, omega, betay, 0, p, tau, y, X, R, K, G1, G2)
    ...
    for (iscan in 1:nscan) {
        ...
        if (sampling == 'whole') {
            ...
            ## ll of candidate
            loglikec <- LLBiMixToursMNAR(gamma1c, beta1c, gamma2c, beta2spc, muc, sigmac, muc, sigmac, omegac, omegac, omegac, omegac, betayc, 0, pc, tau, y, X, R, K, G1, G2)
            ...
            gamma1c <- rnorm(xdim, gamma1, tunegamma1)
            loglikec <- LLBiMixToursMNAR(gamma1c, beta1, gamma2, beta2sp, mu, sigma, mu, sigma, omega, omega, omega, omega, betay, 0, p, tau, y, X, R, K, G1, G2)
            logpriorc <- sum(dnorm(gamma1c, gammapm, gammapv, log = T))
            logprioro <- sum(dnorm(gamma1, gammapm, gammapv, log = T))
            ratio <- loglikec + logpriorc - loglikeo - logprioro
            if (log(runif(1)) <= ratio) {
            ...
            ## beta1
            beta1c <- rnorm(1, beta1, tunebeta1)
            loglikec <- LLBiMixToursMNAR(gamma1, beta1c, gamma2, beta2sp, mu, sigma, mu, sigma, omega, omega, omega, omega, betay, 0, p, tau, y, X, R, K, G1, G2)
            ...
            ## gamma2
            gamma2c <- rnorm(xdim, gamma2, tunegamma2)
            loglikec <- LLBiMixToursMNAR(gamma1, beta1, gamma2c, beta2sp, mu, sigma, mu, sigma, omega, omega, omega, omega, betay, 0, p, tau, y, X, R, K, G1, G2)
            ...
            loglikec <- LLBiMixToursMNAR(gamma1, beta1, gamma2, beta2sp, muc, sigma, muc, sigma, omega, omega, omega, omega, betay, 0, p, tau, y, X, R, K, G1, G2)
            ...
            ## sigma
            sigmac <- pmax(0.01, rnorm(K, sigma, tunesigma))
            loglikec <- LLBiMixToursMNAR(gamma1, beta1, gamma2, beta2sp, mu, sigmac, mu, sigmac, omega, omega, omega, omega, betay, 0, p, tau, y, X, R, K, G1, G2)
            ...
            loglikec <- LLBiMixToursMNAR(gamma1, beta1, gamma2, beta2sp, mu, sigma, mu, sigma, omegac, omegac, omegac, omegac, betay, 0, p, tau, y, X, R, K, G1, G2)
            ...
            ## betay
            betayc <- rnorm(1, betay, tunebetay)
            loglikec <- LLBiMixToursMNAR(gamma1, beta1, gamma2, beta2sp, mu, sigma, mu, sigma, omega, omega, omega, omega, betayc, 0, p, tau, y, X, R, K, G1, G2)
            ...
            ## p
            pc <- max(min(rnorm(1, p, tunep), 0.99), 0.01)
            loglikec <- LLBiMixToursMNAR(gamma1, beta1, gamma2, beta2sp, mu, sigma, mu, sigma, omega, omega, omega, omega, betay, 0, pc, tau, y, X, R, K, G1, G2)
        ...
        ## Update G1, G2,
        updateg1g2 <- .Fortran("updategmnar",
                               x = as.double(X),
                               gamma1 = as.double(gamma1),
                               beta1 = as.double(beta1),
                               gamma2 = as.double(gamma2),
